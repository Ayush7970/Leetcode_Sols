class RandomizedSet:
    """
    Great question, I indetified the dat structures correctly, the only tricky part for this question was how will you make sure that the element from the array can be popped put with O(1) when the index is know. You just have to replace the value of the index with the value at last element adn then pop the last value of the array.
    """
